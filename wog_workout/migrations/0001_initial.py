...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'permissions': (('view_workout', 'Can view the workout and its content'), ('modify_workout', 'Can modify the workout and its content'), ('admin_workout', 'Can administer the workout and its content')),
            },
        ),
        migrations.AddField(
            model_name='session',
