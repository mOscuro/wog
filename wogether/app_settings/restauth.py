...
REST_AUTH_SERIALIZERS = {
    'LOGIN_SERIALIZER': 'wog_user.authentication.serializers.CustomLoginSerializer',
    'PASSWORD_RESET_SERIALIZER': 'wog_user.authentication.serializers.CustomPasswordResetSerializer',
    'PASSWORD_RESET_CONFIRM_SERIALIZER': 'wog_user.authentication.serializers.CustomPasswordResetConfirmSerializer',
    'PASSWORD_CHANGE_SERIALIZER': 'wog_user.authentication.serializers.CustomPasswordChangeSerializer',
    'USER_DETAILS_SERIALIZER': 'wog_user.authentication.serializers.UserDetailsSerializer',
}
...
REST_AUTH_REGISTER_SERIALIZERS = {
    'REGISTER_SERIALIZER': 'wog_user.registration.serializers.CustomRegisterSerializer',
}
