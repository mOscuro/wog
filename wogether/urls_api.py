...
from wog_workout.views import WorkoutViewSet, WorkoutSessionViewSet
...
# router.register(r'equipments', EquipmentViewSet) # Give access to user sessions and public sessions 
...
workouts_router.register(r'sessions', WorkoutSessionViewSet, base_name='workout-sessions')
