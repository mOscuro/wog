...
class Round(models.Model):
    ...
    """
    workout = models.ForeignKey('wog_workout.Workout', related_name='rounds', on_delete=models.CASCADE)
...
class Step(models.Model):
    ...
    exercise = models.ForeignKey('wog_exercise.Exercise', on_delete=models.CASCADE)
