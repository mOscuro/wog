...
class Command(BaseCommand):
    help = 'Creates Group for authenticated user with model permissions'

    def handle(self, *args, **options):
        auth_group, _ = Group.objects.get_or_create(name=AUTHENTICATED_USER_GROUP)
        
        # Workout permissions for authenticated users
        ...
        self.stdout.write(self.style.SUCCESS('Group successfully created'))
